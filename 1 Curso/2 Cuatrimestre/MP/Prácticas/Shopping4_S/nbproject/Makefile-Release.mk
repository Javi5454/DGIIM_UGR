...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/shopping4_s

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/shopping4_s: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/shopping4_s ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/tests/06.UnitMatrix.o: tests/06.UnitMatrix.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -D__RELEASE__ -I../MPTest/include -I../googletest-master/googletest/include -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tests/06.UnitMatrix.o tests/06.UnitMatrix.cpp
...
${OBJECTDIR}/tests/06.UnitMatrix_nomain.o: ${OBJECTDIR}/tests/06.UnitMatrix.o tests/06.UnitMatrix.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -D__RELEASE__ -I../MPTest/include -I../googletest-master/googletest/include -Iinclude -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tests/06.UnitMatrix_nomain.o tests/06.UnitMatrix.cpp;\
	else  \
